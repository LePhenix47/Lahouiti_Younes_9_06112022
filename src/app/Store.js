...
class ApiEntity {
  ...
  async select({ selector, headers = {} }) {
    console.log("Store.js, line 56: selecting a bill");
  ...
  async list({ headers = {} } = {}) {
    console.log("Store.js, line 63: getting the list");
    return await this.api.get({
      url: `/${this.key}`,
      headers: getHeaders(headers),
    });
  ...
  async update({ data, selector, headers = {} }) {
    console.log("Store.js, line 68: updating a bill");
    console.log({ updatedBill: data, selector });
  ...
  async create({ data, headers = {} }) {
    console.log("Store.js, line 75: creating a new bill");
  ...
  async delete({ selector, headers = {} }) {
    console.log("Store.js, line 84: deleting a bill");
    console.log({ selector });
